...
class OurModel(nn.Module):
    def __init__(self, pretrained_path=None, num_classes=1, all_channel=256, all_dim=26 * 26,
        ...
        self.pred1 = nn.Sequential(nn.Conv2d(256, 8, 3, padding=1, stride=1, bias=False),
                                   nn.BatchNorm2d(8),
        ...
        self.off2d_1 = nn.Conv2d(512, 18 * 8, 3, padding=1, bias=True)
        ...
        self.off2d_2 = nn.Conv2d(512, 18 * 8, 3, padding=1, bias=True)
        ...
        self.off2d_3 = nn.Conv2d(512, 18 * 8, 3, padding=1, bias=True)
        # self.deconv_2 = ConvOffset2d(256, 256, 3, padding=1, num_deformable_groups=8)
        ...
        #                                  norm='BN')
        self.deconv2 = UpsampleConvLayer(128 + 256, 128, kernel_size=3, stride=1, upsample=2, bias=False,
                                         norm='BN')
